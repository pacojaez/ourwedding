<div class="p-6 bg-white border-b border-gray-200 sm:px-2">
    <div>
        {{--
    ...
    <div class="mt-2 text-2xl text-center">
        Welcome to our Wedding!!!! Yujuuuu!!!!
    </div>
    <div class="mt-2 text-gray-800 text-xl">
        <p class="p-2 m-2">
            Si has recibido una invitación con un usuario y contraseña es que queremos compartir contigo este día tan
            especial para nosotros.
        </p>
        <p class="p-2 m-2">
            Aquí encontrarás toda la información útil, relevante y necesaria para acudir a nuestra boda.
        </p>
        <p class="p-2 m-2">
            Sólo hace falta que traigas dos cosas: TU PRESENCIA Y MUCHAS DOSIS DE BUEN ROLLO. Nada más. Enough.
        </p>
        <p class="p-2 m-2">
            Con eso creemos y esperamos que pases un día guay, que nos divirtamos, porque la vida no es lo que tienes si
            no con quien lo compartes
            y como nosotros hemos decidio compartir nuestra vida en común, querríamos que de este día te llevaras un
            muy buen recuerdo.
        </p>
    </div>
    <div class="grid grid-cols-1 bg-gray-200 bg-opacity-25 md:grid-cols-2">
        <div class="p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg font-semibold leading-7 text-gray-600"><a href="{{ route('mapa') }}">MAPA</a>
                </div>
            </div>
            ...
            <div class="ml-12">
                ...
                <p class="text-base">No te pierdas!!!</p>
                <a href="{{ route('mapa') }}">
        ...
        <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg font-semibold leading-7 text-gray-600"><a href="{{ route('elmenu') }}">EL MENU</a>
                </div>
            </div>
            <div class="ml-12">
                <div class="mt-2 text-lg text-gray-500">
                ...
                <p>Esto es lo que cenaremos, ¿te ape??</p>
                <a href="{{ route('elmenu') }}">
                    <div class="flex items-center mt-3 text-sm font-semibold text-indigo-700">
                        <div>VER</div>
