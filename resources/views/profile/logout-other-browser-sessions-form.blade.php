<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Gestiona y cierra las sesiones en otros navegadores y dispositivos') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Para que puedas cerrar sesiones abiertas en otros dispositivos') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar todas las sesiones en otros navegadores') }}
            </x-jet-button>
