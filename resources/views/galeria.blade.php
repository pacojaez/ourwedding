<x-gallery-layout>
    ...
    @endif
    {{-- <x-slot name="content"> --}}
        <div class="flex flex-col items-center xl:w-full py-4 justify-self-start">
            <h2 class="m-2 text-lg font-bold leading-none text-green-900 xl:text-xl font-abhaya-libre uppercase">
