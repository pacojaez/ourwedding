...
<head>
    ...
    <style type="text/css" emogrify="no">
        @media (max-width: 600px) {
            ...
            .r11-o {
                background-image: url('https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTI3NTF8MHwxfHNlYXJjaHw4fHx3ZWRkaW5nfGVufDB8fHx8MTY0MjA2MzkxMg&ixlib=rb-1.2.1&q=80&w=1080') !important;
                border-style: solid !important;
                width: 100% !important
            }
            ...
            .r27-o {
                background-image: url('https://images.unsplash.com/photo-1519225421980-715cb0215aed?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTI3NTF8MHwxfHNlYXJjaHw5fHx3ZWRkaW5nfGVufDB8fHx8MTY0MjA2MzkxMg&ixlib=rb-1.2.1&q=80&w=1080') !important;
                border-style: solid !important;
                width: 100% !important
            }
    ...
    <table cellspacing="0" cellpadding="0" border="0" role="presentation" class="nl2go-body-table" width="100%"
        ...
        <tr>
            <td align="center" class="r0-c">
                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r11-o"
                    style="background-color: #eff2f7; background-image: url('https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?crop=entropy&amp;cs=tinysrgb&amp;fit=max&amp;fm=jpg&amp;ixid=MnwxMTI3NTF8MHwxfHNlYXJjaHw4fHx3ZWRkaW5nfGVufDB8fHx8MTY0MjA2MzkxMg&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1080'); font-size: 0; table-layout: fixed; width: 100%;">
                    <!-- -->
                    <tr>
                        <td valign="top" class="">
                                                                                        ...
                                                                                        <table cellspacing="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 24px; line-height: 1.5; text-align: center;">
                                                                                                    <div>
                                                                                                        <h1 class="default-heading1"
                                                                                                            style="margin: 0px;">
                                                                                                            Hola {{ ucfirst($user->name) }}
                                                                                                        </h1>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        ...
                                                                                        <table cellspacing="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <h2 class="default-heading1"
                                                                                                            style="font-size: 16px; margin: 0px;">
                                                                                                            Tenemos algunas novedades que contarte
                                                                                                    </h2>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        ...
                                                                                        <table cellspacing="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <h1 class="default-heading1"
                                                                                                            style="color: #1F2D3D; font-family: arial,helvetica,sans-serif; font-size: 14px; margin: 0px;">
                                                                                                            Para ingresar tu usuario es tu mail
                                                                                                        </h1>
                                                                                                    </div>
                                                                                                    <div>
                                                                                                        <h1 class="default-heading1"
                                                                                                            style="color: #1F2D3D; font-family: arial,helvetica,sans-serif; font-size: 14px; margin: 0px;">
                                                                                                            y tu contraseña: password
                                                                                                        </h1>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 14px; line-height: 1.5; text-align: center;">
                                                                                                    <div>
                                                                                                        <h1 class="default-heading1"
                                                                                                            style="color: #1F2D3D; font-family: arial,helvetica,sans-serif; font-size: 14px; margin: 0px;">
                                                                                                            ¡¡Acuerdate de cambiarla una vez ingreses!!
                                                                                                        </h1>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
        ...
        <tr>
            <td class="r16-c" align="center">
                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%"
                    ...
                    <tr>
                        <td class="r17-i" style="background-color: #ffffff;">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                <tr>
                                    <th width="50%" valign="top" class="r6-c">
                                        <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                            width="100%" class="r1-o"
                                            style="table-layout: fixed; width: 100%;">
                                            <!-- -->
                                            <tr>
                                                <td class="nl2go-responsive-hide" width="15"
                                                                                            ...
                                                                                            <td align="left"
                                                                                                ...
                                                                                                <div>
                                                                                                    <h4 class="default-heading4"
                                                                                                        style="color: #1F2D3D; font-family: arial,helvetica,sans-serif; font-size: 18px; margin: 0px;">
                                                                                                        <span
                                                                                                            style="background-color: #ffffff; color: #181515; font-size: 16px;"><u>Cualquier
                                                                                                                duda
                                                                                                                que
                                                                                                                os
                                                                                                                surja
                                                                                ...
                                                                                <td class="r16-c"
                                                                                    ...
                                                                                    <table cellspacing="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="r15-i"
                                                                                                style="font-size: 0px; line-height: 0px;">
                                                                                                <img src="{{ asset('img/wedding/9.jpg')}}"
                                                                                                width="70"
                                                                                                border="0"
                                                                                                class=""
                                                                                                style="display: block; width: 100%;">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                <div>
                                                                                                    <p
                                                                                                        style="font-size: 14px; margin: 0px;">
                                                                                                        ¿Dudas? Nuestros mails:
                                                                                                        {{ $novia->email }}&amp;{{ $novio->email }}
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                <div>
                                                                                                    <p
                                                                                                        style="font-size: 14px; margin: 0px;">
                                                                                                        Has recibido este mail porque te consideramos parte de nuestra familia.
                                                                                                    </p>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
