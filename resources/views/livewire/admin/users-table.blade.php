                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr class="bg-blue-200 lg:text-black">
                                    ...
                                    <td class="p-2">
                                        @if ($user->invitated)
                                            <span class="px-2 text-xs bg-green-400 rounded-md text-gray-50 lg:text-lg">
                                                INVITACION ENVIADA
                                            </span>
                                        @else
                                            <span class="px-2 text-xs bg-red-400 rounded-md text-gray-50 lg:text-lg">
                                                NO ENVIADA
                                            </span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="p-3">
                                        ...
                                        @if ( !$user->invitated)
                                            <x-jet-button wire:click="sendInvitation( {{ $user->id }})"
        ...
        <x-jet-confirmation-modal wire:model="confirmingUsuarioDeletion" class="z-40">
            ...
            <x-slot name="footer">
                <x-jet-danger-button class="ml-2"
                    wire:click="deleteUsuario({{ $confirmingUsuarioDeletion }})" wire:loading.attr="disabled">
                    {{ __('Eliminar') }}
                </x-jet-danger-button>
            </x-slot>
