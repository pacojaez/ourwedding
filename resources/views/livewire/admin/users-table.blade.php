                    ...
                    <table class="table space-y-6 overflow-scroll text-sm text-gray-600 border-separate">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-blue-200 lg:text-black">
                                ...
                                <td class="p-2">
                                    @if ($user->confirmed)
                                    <span class="px-2 text-xs bg-green-400 rounded-md text-gray-50 lg:text-lg">CONFIRMADO</span>
                                    @else
                                    <span class="px-2 text-xs bg-red-400 rounded-md text-gray-50 lg:text-lg">NO CONFIRMADO</span>
                                    @endif
                                </td>
                                <td class="p-3">
