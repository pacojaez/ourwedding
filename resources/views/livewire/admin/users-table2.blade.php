    ...
    <div class="flex flex-col w-full min-h-screen bg-white">
        <div class="col-span-12">
            <div class="overflow-auto lg:overflow-visible">
                <div class="flex flex-col md:flex-row pb-1 border-b-2 lg:justify-between border-fuchsia-900">
                    <h2 class="text-xl font-bold text-gray-700">TODOS LOS INVITADOS</h2>
                    <h2 class="text-xl font-bold text-gray-700">Actualmente hay confirmados {{ $confirmed }} invitados</h2>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-blue-200 lg:text-black">
                                ...
                                <td class="p-3">
                                    ...
                                    <button wire:click="confirmUsuarioEdit( {{ $user->id }})"
                                        class="bg-orange-500 hover:bg-orange-700">
                                        Edit
                                    </button>
                                    <button wire:click="confirmUsuarioDeletion( {{ $user->id }})"
        ...
        @if($users->hasMorePages())
            <div class="flex flex-row justify-center my-4">
                <button wire:click.prevent="loadMore" class="bg-blue-500 hover:bg-blue-700 text-center">
                    Load more
                </button>
            </div>
        @endif
        ...
        <x-jet-confirmation-modal wire:model="confirmingUsuarioDeletion" class="z-30">
            ...
            <x-slot name="content">
                {{ __('¿Seguro que deseas borrar el invitado? ') }}
            </x-slot>
        ...
        <x-jet-dialog-modal wire:model="confirmingUsuarioAdd" class="z-30">
            ...
            <x-slot name="content">
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="user.name" value="{{ __('NOMBRE') }}" />
